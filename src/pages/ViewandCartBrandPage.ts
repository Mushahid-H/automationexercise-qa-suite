...
export class ViewandCartBrandPage {
    ...
    constructor(page: Page) {
        this.page = page;
        this.brandHeading = page.locator('.brands_products').locator('h2', { hasText: 'Brands' });
    ...
    async ensureBrandsVisible() {
        await this.brandHeading.scrollIntoViewIfNeeded(); // keep only if you need the scroll itself verified
